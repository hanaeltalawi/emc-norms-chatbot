...
Usage: python model_comparison_report/standalone_model_comparison_only_tables.py model_comparison_report/Translated_Norm.docx
"""
...
TEST_QUESTIONS = [
    {
        "id": "Q1",
        "question": "What resolution bandwidth (RBW) is applied to FM (76–108 MHz)?",
        "expected_answer": "120 kHz."
    },
    {
        "id": "Q2", 
        "question": "What is the mean limit for DAB-L-Band (1447–1494 MHz)?",
        "expected_answer": "22 dB(µV)."
    },
    {
        "id": "Q3",
    ...
    },
    {
        ...
        "expected_answer": "DAB III, FM, TV Band I, TV Band III, and TV Band IV."
    },    
    {
        "id": "Q5",
        "question": "What additional testing considerations should be accounted for in complex vehicle systems?",
        "expected_answer": "Complex vehicle systems may require additional testing considerations such as multiple DUT configurations, varying load conditions, and specific installation scenarios to ensure comprehensive electromagnetic compatibility assessment."
    },
    {
        "id": "Q6",
    ...
    },
    {
        ...
        "expected_answer": "Peak limit is 32 dB(µV), mean limit also 32 dB(µV)."
    },
    {
        "id": "Q9",
